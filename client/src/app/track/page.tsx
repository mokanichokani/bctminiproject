...
export default function Track() {
  ...
  const TrackComponent = ({
    ...
    return (
      <div className="max-w-6xl mx-auto font-mono text-neo-dark">
        {/* Medicine Info Card */}
        <div className="bg-neo-primary border-4 border-black shadow-neo p-8 mb-8 text-black">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center space-x-4">
              <div className="w-16 h-16 bg-white border-4 border-black flex items-center justify-center shadow-neo-active">
                <svg className="w-10 h-10 text-black" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                </svg>
              </div>
              <div>
                <h3 className="text-3xl font-black uppercase mb-2">Battery Information</h3>
                <p className="text-black font-bold text-sm">Track ID: {med[medicineId]?.id}</p>
              </div>
            </div>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-white border-2 border-black p-4 shadow-neo-active">
              <div className="text-sm font-black uppercase mb-1">Name</div>
              <div className="text-lg font-bold">{med[medicineId]?.name}</div>
            </div>
            <div className="bg-white border-2 border-black p-4 shadow-neo-active">
              <div className="text-sm font-black uppercase mb-1">Description</div>
              <div className="text-lg font-bold truncate">{med[medicineId]?.description}</div>
            </div>
            <div className="bg-white border-2 border-black p-4 shadow-neo-active">
              <div className="text-sm font-black uppercase mb-1">Current Stage</div>
              <div className="text-lg font-bold">{medStage[medicineId]}</div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white border-4 border-black shadow-neo p-8 mb-8">
          <h4 className="text-2xl font-black text-black uppercase mb-8 flex items-center">
          ...
          <div className="relative">
            {/* Timeline line */}
            <div className="absolute left-8 top-0 bottom-0 w-1 bg-black hidden md:block"></div>

            <div className="space-y-8">
              {stages.map((stage, index) => (
                <div key={index} className="relative flex items-start">
                  {/* Timeline dot */}
                  <div className="relative z-10 flex-shrink-0 w-16 h-16 bg-neo-secondary border-4 border-black flex items-center justify-center shadow-neo-active transform hover:scale-110 transition-transform">
                    {stage.icon || (
                  ...
                  {/* Content card */}
                  <div className="ml-6 flex-1 bg-neo-light border-2 border-black p-6 shadow-neo-active hover:shadow-neo-hover transition-all">
                    <h5 className="text-lg font-black text-black uppercase mb-3 flex items-center flex-wrap gap-2">
                      {stage.label}
                      {stage.data && (
                        <span className="ml-2 px-2 py-1 bg-neo-accent border-2 border-black text-black text-xs font-black uppercase">
                          ✓ Completed
                        </span>
                      )}
                    </h5>
                    {stage.data ? (
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div className="bg-white border-2 border-black p-3 shadow-sm">
                          <div className="text-xs font-bold uppercase mb-1">ID</div>
                          <div className="font-bold text-black">{stage.data.id}</div>
                        </div>
                        <div className="bg-white border-2 border-black p-3 shadow-sm">
                          <div className="text-xs font-bold uppercase mb-1">Name</div>
                          <div className="font-bold text-black">{stage.data.name}</div>
                        </div>
                        <div className="bg-white border-2 border-black p-3 shadow-sm">
                          <div className="text-xs font-bold uppercase mb-1">Location</div>
                          <div className="font-bold text-black">{stage.data.place}</div>
                        </div>
                        <div className="md:col-span-3 bg-white border-2 border-black p-3 shadow-sm">
                          <div className="text-xs font-bold uppercase mb-1">Address</div>
                          <div className="font-mono text-xs text-black break-all font-bold">{stage.data.addr}</div>
                        </div>
                      </div>
                    ) : (
                      <div className="bg-neo-primary border-2 border-black p-4">
                        <p className="text-black font-black uppercase">⏳ Not yet processed</p>
                      </div>
                    )}
                  </div>
                  ...
                  {stage.showArrow && index < stages.length - 1 && (
                    <div className="hidden md:block absolute left-8 top-16 w-1 h-8 bg-black"></div>
                  )}
                </div>
              ))}
            </div>
        ...
        {trackTillOrdered && (
          <div className="bg-white border-4 border-black shadow-neo p-8 mb-8">
            <h4 className="text-2xl font-black text-black uppercase mb-4 flex items-center">
              <svg className="w-6 h-6 mr-2 text-black" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex justify-center">
              <div className="bg-white p-6 border-4 border-black shadow-neo-active">
                <QRCodeCanvas
                  ...
                  includeMargin={true}
                />
                <p className="text-center text-sm text-black mt-4 font-black uppercase">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <button
            ...
            className="flex-1 px-6 py-4 bg-neo-secondary border-2 border-black text-black font-black uppercase hover:bg-neo-primary transition-all shadow-neo-active hover:shadow-neo-hover hover:-translate-y-1 flex items-center justify-center"
          >
          ...
          <button
            onClick={() => router.push('/')}
            className="flex-1 px-6 py-4 bg-neo-primary border-2 border-black text-black font-black uppercase hover:bg-neo-secondary transition-all shadow-neo-active hover:shadow-neo-hover hover:-translate-y-1 flex items-center justify-center"
          >
            <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  if (trackTillSold) {
    const medicineId = parseInt(id)
    return (
      <div className="min-h-screen bg-neo-bg p-5">
        <TrackComponent
          title="Sold"
          stages={[
            {
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-white border-4 border-black shadow-neo p-6 mb-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 mb-4">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-3xl font-black text-black uppercase">Track Materials</h1>
                <p className="text-gray-800 font-bold text-sm">Monitor your battery journey through the supply chain</p>
              </div>
            </div>
            <button
              onClick={() => router.push('/')}
        ...
        <div className="bg-white border-4 border-black shadow-neo p-8 mb-8">
          <div className="flex items-center mb-6">
            ...
            <h2 className="text-2xl font-black text-black uppercase">Enter Battery ID to Track</h2>
          </div>
          <form onSubmit={handlerSubmit} className="flex flex-col md:flex-row gap-4">
              ...
              <table className="min-w-full border-2 border-black">
                <thead>
                  <tr className="bg-neo-secondary border-b-2 border-black">
                    ...
                    <th className="px-6 py-4 text-left text-sm font-black text-black uppercase border-r-2 border-black">Current Stage</th>
                    <th className="px-6 py-4 text-left text-sm font-black text-black uppercase">Action</th>
                  </tr>
                </thead>
                <tbody className="divide-y-2 divide-black">
                  {Object.keys(med).map((key) => {
                    ...
                    return (
                      <tr key={key} className="hover:bg-neo-light transition-colors cursor-pointer" onClick={() => trackMedicine(medicineId)}>
                        <td className="px-6 py-4 border-r-2 border-black">
                          <div className="flex items-center">
                            ...
                            <span className="font-bold text-black">{med[medicineId].id}</span>
                          </div>
                        </td>
                        <td className="px-6 py-4 font-bold text-black border-r-2 border-black">{med[medicineId].name}</td>
                        <td className="px-6 py-4 text-gray-800 font-medium border-r-2 border-black">{med[medicineId].description}</td>
                        <td className="px-6 py-4 border-r-2 border-black">
                        ...
                        <td className="px-6 py-4">
                          <button
                            ...
                            className="px-4 py-2 bg-neo-primary border-2 border-black text-black rounded-none hover:bg-neo-secondary transition-all text-sm font-black uppercase shadow-neo-active hover:shadow-neo-hover hover:-translate-y-1 flex items-center"
                          >
