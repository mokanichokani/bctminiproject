    ...
    <div className="fixed top-4 right-4 bg-yellow-100 border-l-4 border-yellow-500 text-yellow-700 p-4 rounded-lg shadow-lg max-w-md z-50">
      <div className="flex items-start">
        ...
        <div className="ml-3 flex-1">
          ...
          <div className="mt-4 text-xs text-yellow-800 bg-yellow-200 p-2 rounded">
            <strong>Troubleshooting:</strong>
            <ul className="list-disc pl-4 mt-1 space-y-1">
              <li>If switching fails, go to MetaMask <strong>Settings &gt; Advanced &gt; Clear Activity Tab Data</strong> (or Reset Account).</li>
              <li>Ensure Hardhat node is running (<code>npx hardhat node</code>).</li>
            </ul>
          </div>
        </div>
      </div>
